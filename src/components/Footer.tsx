      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            >
              Leading the way in global financial excellence and education, providing innovative solutions since 2004.
            </motion.p>
            <motion.div
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                ...
                { path: '/global-finance', label: 'Global Finance' }
              ].map((link, index) => (
                <motion.li
                  key={link.path}
                ...
                >
                  <Link to={link.path} className="text-primary-100 hover:text-white transition-colors flex items-center group">
            ...
            <ul className="space-y-2">
              {[
                ...
                <motion.li
                  ...
                  transition={{ duration: 0.3, delay: index * 0.1 }}
                >
                  <Link to={service.path} className="text-primary-100 hover:text-white transition-colors flex items-center group">
                    <ArrowRight className="w-4 h-4 mr-2 transform group-hover:translate-x-1 transition-transform" />
                    {service.label}
                  </Link>
                </motion.li>
          ...
          <div>
            ...
            <div className="space-y-3">
              {[
                { Icon: MapPin, text: "123 Financial District<br />Kolkata, West Bengal<br />India 700001" },
                { Icon: Phone, text: "+91 98765 43210" },
                { Icon: Mail, text: "contact@mahasamvit.com" },
                { Icon: Globe, text: "www.mahasamvit.com" }
              ].map((item, index) => (
                <motion.div
                  key={index}
                ...
                >
                  <item.Icon className="w-5 h-5 text-primary-300 mr-3 mt-0.5" />
                  <p
        ...
        >
          <div className="flex flex-col md:flex-row md:justify-between items-center">
            <p className="text-primary-100 mb-4 md:mb-0">
              &copy; {new Date().getFullYear()} Mahasamvit International Ltd. All rights reserved.
            </p>
            <div className="flex space-x-6">
              <Link to="/terms" className="text-primary-200 hover:text-white transition-colors">Terms of Service</Link>
              <Link to="/privacy" className="text-primary-200 hover:text-white transition-colors">Privacy Policy</Link>
              <Link to="/cookies" className="text-primary-200 hover:text-white transition-colors">Cookie Policy</Link>
            </div>
          </div>
        </motion.div>
      </div>
